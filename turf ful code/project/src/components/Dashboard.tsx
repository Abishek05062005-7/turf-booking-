...
import { Calendar, Clock, MapPin, User, CreditCard, CheckCircle, AlertCircle, X, Edit, Mail, Phone } from 'lucide-react';
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-green-600 font-medium capitalize">{user?.role} Account</p>
              </div>
            </div>
